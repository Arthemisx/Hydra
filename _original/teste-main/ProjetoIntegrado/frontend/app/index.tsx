...
import { logoSaoCamilo, setaSidebar } from "@/assets/appImages";
...
export default function Index() {
  ...
  const [activeScreen, setActiveScreen] = useState<"athlete" | "coach" | "report" | "about" | "help">("athlete");
  ...
  const heroLogoSize = useMemo(() => {
    const w = Math.min(280, Math.max(200, width - 110));
    return { width: w, height: 88 };
  }, [width]);

  const sidebarLogoSize = useMemo(() => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.sidebarOverlay}>
          <View style={styles.sidebar}>
            <View style={styles.sidebarBrand}>
              <Image
                source={logoSaoCamilo}
                style={[styles.sidebarLogoThumb, sidebarLogoSize]}
                accessibilityLabel="Logo Sao Camilo"
              />
      ...
      {activeScreen === "report" ? (
        <ReportScreen athleteName={form.athleteName} apiBaseUrl={apiBaseUrl} />
      ) : activeScreen === "about" ? (
          ...
          <View style={styles.contentCard}>
            <View style={styles.topBar}>
              <View style={styles.titleBlock}>
                <Image source={logoSaoCamilo} style={[styles.logoImage, heroLogoSize]} accessibilityLabel="Logo Sao Camilo" />
