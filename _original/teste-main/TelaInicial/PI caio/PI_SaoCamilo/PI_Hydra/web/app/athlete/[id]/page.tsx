          ...
          <div className="card">
            ...
            <div className="stats-grid">
              <div className="stat-card">
                ...
                <div className="stat-label">Sessoes concluidas</div>
              </div>
              <div className={`stat-card ${avgVariation > 2 ? "danger" : avgVariation > 1 ? "caution" : "normal"}`}>
                ...
                <div className="stat-label">Variacao media</div>
              </div>
              <div className="stat-card">
                <div className="stat-value">
                  {avgSweatRate.toFixed(2)}<span className="stat-unit"> L/h</span>
                </div>
                <div className="stat-label">Taxa sudorese media</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="card">
          ...
          {sessions.length === 0 ? (
            <div className="empty-state">
              <p>Nenhuma sessao registrada para este atleta.</p>
            </div>
          ) : (
