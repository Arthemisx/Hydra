...
export default function SessionDetailPage() {
  ...
  const alertMessages: Record<string, { text: string; class: string }> = {
    danger: {
      text: "Desidratação severa! Perda acima de 2% da massa corporal. Revise a estrategia de hidratação.",
      class: "alert-danger",
    },
    caution: {
      text: "Atenção! Perda entre 1-2% da massa corporal. Considere aumentar a ingestão de fluidos.",
      class: "alert-caution",
    },
    normal: {
      text: "Hidratação adequada. Continue com a estratégia atual.",
      class: "alert-normal",
    },
  };
        ...
        <div className="card">
          ...
          {session.soaked_clothing && (
            <p style={{ marginTop: "0.5rem", color: "var(--yellow-caution)" }}>
              ⚠ Roupas encharcadas registradas — possível erro na pesagem
            </p>
          )}
        </div>
